...
| 武器       | 質量       | 體積    | 銳器穿透(武器握柄/刺/劈砍) | 鈍器穿透(武器握柄/刺/劈砍) | 冷卻時間(武器握柄/刺/劈砍)   | 每擊傷害(武器握柄/刺/劈砍)    | WTM(再除以60就是工作量) | 市場價值     | 平均每秒傷害    | 科技需求                                                                 |
|----------| -------- | ----- | --------------- |-----------------| ----------------- | ------------------ | --------------- |----------|-----------|----------------------------------------------------------------------|
| 鐵長劍      | 2        | 8     | 13%/34%/34%     | -               | 2/2.6/2.6         | 9/23/23            | 18000/18000     | 225      | 8.6       | 長劍                                                                   |
| **甩棍**   | **0.55** | **1** | **-**           | **5.6%/13%**    | **1.2/1.2(head)** | **3.75/9.5(head)** | **10000/10000** | **103**  | **7.27**  | **機械加工**                                                             |
| **充能長劍** | **1.53** | **8** | **3%/60%/27%**  | **-**           | **1.5/1.38/1.22** | **4/18/40**        | **42000/42000** | **1920** | **29.08** | **電荷彈(如果在原版環境) / 動力近戰武器Powered melee weapons(如果安裝了"CE - 近戰擴展"的mod)** |
| 鐵釘頭錘     | 1.25     | 3.5   | -               | 13%/24%         | 1.2/1.2(head)     | 9/15.7(head)       | 6000/6000       | 117      | 7.02      | 鍛造                                                                   |

CE數據：

| 武器                                                                   | 質量       | 體積    | 銳器穿透(武器握柄/刺/劈砍)                           | 鈍器穿透(武器握柄/刺/劈砍)     | 冷卻時間(武器握柄/刺/劈砍)   | 每擊傷害(武器握柄/刺/劈砍)   | WTM(再除以60就是工作量) | 市場價值     | 平均每秒傷害    | 科技需求                                                                 |
|----------------------------------------------------------------------| -------- | ----- | ----------------------------------------- |---------------------| ----------------- | ----------------- | --------------- | -------- |-----------|----------------------------------------------------------------------|
| 鐵長劍                                                                  | 2        | 8     | 2/0.72                                    | 1/1/3.24            | 1.78/1.78/1.64    | 4/18/40           | 18000/18000     | 225      | 16.54     | 長劍                                                                   |
| PoweredShortSword充能短劍(來自: CE - 近戰擴展)(CE only)                        | 0.65     | 3.5   | 9.2/6.6                                   | 0.33/0.47/1.96      | 1.35/1.12/1       | 2/27/20           | -/32000         | 885      | 19.54     | 動力近戰武器Powered melee weapons(如果安裝了"CE - 近戰擴展"的mod)                    |
| **充能長劍**                                                             | **1.53** | **8** | **15.4/11.05 (Can penetrate Armor Vest)** | **0.78/1.11/6.615** | **1.5/1.38/1.22** | **4/18/40**       | **42000/42000** | **1920** | **21.95** | **電荷彈(如果在原版環境) / 動力近戰武器Powered melee weapons(如果安裝了"CE - 近戰擴展"的mod)** |
| **甩棍**                                                               | **0.55** | **1** | **-**                                     | **0.78/3.56**       | **1.2/1.2(head)** | **1.5/9.5(head)** | **10000/10000** | **103**  | **7.05**  | **機械加工**                                                             |
| 鐵短劍                                                                  | 0.85     | 3.5   | 0.48/0.43                                 | 0.43/0.43/0.96      | 1.44/1.44/1.34    | 2/27/20           | 12000/12000     | -        | 14.65     | 鍛造                                                                   |
| 鐵釘頭錘                                                                 | 1.25     | 3.5   | -                                         | 0.63/5.63           |                   |                   | 6000/6000       | 117      | 6.25      | 鍛造                                                                   |
| 機械族巨劍(機械族/戰棺 專武) (來自: SawedoffShotgun's Mechanoid_Combat) (玩家暫時無法獲得) | 6.12     | 32    | 102.67/73.67                              | 5.2/7.33/44.1       | 1.5/1.38/1.22     | 16/72/160         | -               | 8330     | 80.58     | -                                                                    |


可能有劇透:

<span style="background-color:black;">    
（如果在 CE 環境中，“銳器暴擊無視護甲”功能會使大部分動力銳器(除了PoweredShortSword(動力短劍)和更小的充能武器)的擊殺蜈蚣的效率比PoweredMaul(充能大槌，屬於"Combat Extended Melee" Mod)還高，（瞄準頭部模式））。    

充能長劍 vs 充能德式大劍:    
擊殺蜈蚣的速率: 7.5(長劍) / 10(德式大劍贏)    
殺飛螳速率: 3(長劍贏) / 2     
殺海盜(半數著防彈衣)速率: 2(長劍贏) / 1(德式大劍(使用砍身子瞄準模式，反正砍哪裡都是一刀秒))    
</span>
